...
(function(){
  ...
  styfn.types = {
    ...
    curveStyle: { enums: [ 'bezier', 'unbundled-bezier', 'haystack', 'segments', 'straight', 'taxi', 'custom' ] },
    ...
    valign: { enums: [ 'top', 'top-inner', 'center', 'bottom-inner', 'bottom' ] },
    halign: { enums: [ 'left', 'left-inner', 'center', 'right-inner', 'right' ] },
  ...
  let edgeLine = [
    ...
    { name: 'custom-points', type: t.numbers, triggersBounds: diff.any },
